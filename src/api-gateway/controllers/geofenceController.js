...
export const getAllGeofences = catchAsync(async (req, res, next) => {
...
export const disableGeofence = catchAsync(async (req, res, next) => {
  const geofence = await Geofence.findOne({ _id: req.params.id });
...
export const recoverGeofence = catchAsync(async (req, res, next) => {
  const geofence = await Geofence.findOne({ _id: req.params.id });
